...
from .forms import DetailsForm,PostForm,InstaForm
...
def profile_others(request,id):
    ...
    followercount=len(followers)
    return render(request, 'profile_others.html',{"profile_user": profile_user,"posts":posts,"followingcount":followingcount,"followercount":followercount})
...
def search(request):
    ...
    if 'username' in request.GET and request.GET["username"]:
        ...
        if searched_user:
            ...
            return render(request, 'profile_others.html',{"profile_user": searched_user,"posts":posts,"followingcount":followingcount,"followercount":followercount})
        else:
